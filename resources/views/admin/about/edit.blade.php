    ...
    <section class="white-smooth-wrapper no-margin">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('about.update', $about) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="organization-form">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="input-wrapper-sm">
                                    <textarea rows="3" name="content" id="content">{{ old('content', $about->content) }}</textarea>
                                    @error('content')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
