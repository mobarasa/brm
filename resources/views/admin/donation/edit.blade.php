        ...
        <div class="row">
            <div class="col-md-12">
                <div class="wrapper-head semi-head-border with-btn-head clearfix"">
                    <h4>Edit Donation Policy and Procedure</h4>
                    <div class="btn-head-wrap">
                        <a href="{{ route('donations.index') }}">Back</a>
                    </div>
                </div>

                <form action="{{ route('donations.update', $donation) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-wrapper-sm">
                                    <textarea rows="3" name="content" id="content">{{ old('content', $donation->content) }}</textarea>
                                    @error('content')
