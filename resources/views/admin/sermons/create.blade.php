@extends('layouts.master', ['title' => 'New Sermon'])
    ...
    <section class="white-smooth-wrapper no-margin">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('sermons.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="input-wrapper-sm">
                                    <label>Title</label>
                                    <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Sermon title" required autofocus>
                                    @error('title')
                            ...
                            <div class="col-md-4">
                                <div class="input-wrapper-sm">
                                    ...
                                    <input type="text" name="bible_passage" id="bible_passage" value="{{ old('bible_passage') }}" placeholder="e.g. Proverbs 3:5–6" required>
                                    @error('bible_passage')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-8">
                                <div class="input-wrapper-sm">
                                    ...
                                    <input type="text" name="preacher" id="preacher" value="{{ old('preacher') }}" placeholder="Preacher's Name" required>
                                    @error('preacher')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="input-wrapper-sm">
                                    ...
                                    <input class="demo-2" type="text" name="date_preached" id="date_preached" value="{{ old('date_preached') }}" placeholder=" YYYY-MM-DD" required>
                                    @error('date_preached')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="input-wrapper-sm">
                                    ...
                                    <input type="text" name="location" id="location" value="{{ old('location') }}" placeholder="Sermon location e.g. Lurambi" required>
                                    @error('location')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
